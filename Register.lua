...
if SpeakStone_RegisterSoundPack then
    SpeakStone_RegisterSoundPack(addonName, SpeakStoneSoundLengths_Pack_WarlordsofDraenor)
else
    SpeakStonePendingSoundPacks = SpeakStonePendingSoundPacks or {}
    table.insert(SpeakStonePendingSoundPacks,
        { name = addonName, index = SpeakStoneSoundLengths_Pack_WarlordsofDraenor })
end
